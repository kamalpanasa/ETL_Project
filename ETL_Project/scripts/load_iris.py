...
def create_table_if_not_exists():
    try:
        ...
        try:
            ...
            print("Table iris_data created")
        except Exception as e:
            print(f"Note: {e}")
            print("Table will be created automatically")
    except Exception as e:
...
def load_to_supabase(staged_path: str, table_name: str = "iris_data"):
    ...
    if not os.path.exists(staged_path):
        ...
        print("Return to transform_iris.py")
        return
...
if __name__ == "__main__":
    staged_csv_path = os.path.join(os.path.dirname(__file__), "..", "data", "staged", "iris_transformed.csv")
